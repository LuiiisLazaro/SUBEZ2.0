               ...
               <div class="large-12 columns">
                  <div class="control-group">
                     ...
                     <div class="row">
                        <div class="large-12 columns">
                           <label>CURP
                              <asp:TextBox type="text" placeholder="HELL920809HVZRZS07" readonly runat="server"></asp:TextBox>
                           </label>
                        </div>
                     </div>
                     ...
                     <div class="row">
                        <div class="large-12 columns">
                           <label>Nombre(s)
                           <asp:TextBox type="text" placeholder="LUIS ANGEL" readonly runat="server"></asp:TextBox>
                           </label>
                        </div>
                     </div>
                     ...
                     <div class="row">
                        <div class="large-12 columns">
                           ...
                           <asp:TextBox type="text" placeholder="HERNANDEZ" readonly runat="server"></asp:TextBox>
                           </label>
                        </div>
                     </div>
                      ...
                      <div class="row">
                        <div class="large-12 columns">
                           ...
                           <asp:TextBox type="text" placeholder="LAZARO" readonly runat="server"></asp:TextBox>
                           </label>
                        </div>
                     </div>
                     ...
                     <div class="row">
                        <div class="large-12 columns">
                           ...
                           <asp:TextBox  type="text" placeholder="09/08/1992" readonly ID="TextBox2" runat="server"></asp:TextBox>
                           </label>
                        </div>
                     </div>
                      ...
                      <div class="row">
                        <div class="large-12 columns">
                           <label>Nacionalidad
                                <asp:TextBox type="text" id="nacion" readonly runat="server"></asp:TextBox>
                           </label>
                        </div>
                     </div>
