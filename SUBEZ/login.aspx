    ...
    <div class="row">
        <div class="small-6 medium-6 large-6 columns">
            <div class="small-11 medium-9 large-7 columns">
                <img alt="" src="../Image/SeZac.jpg" />
            </div>
        </div>
        <div class="small-6 medium-6 large-6 columns">
            <div class="small-11 medium-9 large-7 columns derecha">
                <img alt="" src="../Image/SeZac2.jpg" />
            </div>
        </div>
    </div>
        ...
        <div class="small-12 medium-12 large-6 columns">
            <div class="small-12 medium-12 large-12 columns">
                ...
                <div class="small-12 medium-6 large-6 columns separa_v">
                    <asp:TextBox ID="txtUserName" runat="server" lass="large-12.columns" onkeyup="this.value=this.value.toUpperCase();"
                        MaxLength="18" placeholder="USUARIO"></asp:TextBox>
                </div>
                <div class="small-12 medium-6 large-6 columns separa_v">
                    <asp:TextBox ID="txtPassword" type="password" runat="server" class="large-12.columns"
                        nkeyup="this.value=this.value.toUpperCase();" MaxLength="18" placeholder="CONTRASEÑA"></asp:TextBox>
                </div>
                <div class="small-12 medium-12 large-12 columns separa_v">
                    <asp:Button ID="LoginButton" runat="server" Text="Inicia sesión" 
                        class="btn btn-flat btn-primary button expand" onclick="LoginButton_Click" />
                    &nbsp;</div>
                ...
                <div class="small-12 medium-12 large-12 columns separa_v" align="right">
                    <a data-toggle="modal" data-reveal-id="recupera" href="RecuperarPassWord.aspx?Opcion=Usuario" class="enlace">No recuerdo
                        mi contraseña</a>
                </div>
                ...
                <div class="small-12 medium-6 large-6 columns separa_v">
                    <asp:Button ID="btnRegistrar" runat="server"  
                        class="btn btn-flat button expand enlace" Text="¡Regístrate ahora!" 
