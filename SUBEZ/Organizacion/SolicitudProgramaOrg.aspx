<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SolicitudProgramaOrg.aspx.cs" Inherits="SeZac.Organizacion.SolicitudProgramaOrg" %>
       ...
       <!-- SECCION TABLA -->
         ...
         <div class="small-12 medium-12 large-9 columns borde_contenedor" role="main">
            <div class="large-12 columns separa_v borde_contenedor">
               <header>
                  <h4>Participación en Programas </h4>
                  <hr>
               </header>
