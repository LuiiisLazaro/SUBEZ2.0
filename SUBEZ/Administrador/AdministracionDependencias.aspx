<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdministracionDependencias.aspx.cs" Inherits="SUBEZ.Administrador.AdministracionDependencias" %>
       ...
       <!-- SECCION TABLA -->
         ...
         <div class="small-12 medium-12 large-9 columns borde_contenedor" role="main">
            <div class="large-12 columns separa_v borde_contenedor">
               <header>
                  <h4>Administración de Dependencias</h4>
                  <hr>
               </header>
               <div class="large-12 columns separa_v" id="mis_s">
                  <a href="RegistroDependencia.aspx">
                            <dx:ASPxButton ID="ASPxButton1" runat="server" Text="Agregar Dependencia" 
                                Theme="Office2003Olive">
                            </dx:ASPxButton>
                        </a>
                            <dx:ASPxButton ID="ASPxButton2" runat="server" Text="Actualizar Dependencias" 
                                Theme="Office2003Olive">
                            </dx:ASPxButton>
                            <dx:ASPxButton ID="ASPxButton3" runat="server" Text="Guardar Cambios" 
                                ...
                                <Columns>
                                    <dx:GridViewDataColumn Caption="Nombre" FieldName="nombre" Settings-AllowSort="True"   VisibleIndex="0">
                                    ...
                                    <dx:GridViewDataColumn Caption="Fecha Alta" FieldName="fechaAlta" Settings-AllowSort="True"   VisibleIndex="0">
                                    </dx:GridViewDataColumn>
                                    <dx:GridViewDataColumn Caption="Primer Contacto" FieldName="primerContacto" Settings-AllowSort="True"   VisibleIndex="0">
                                    </dx:GridViewDataColumn>
                                </Columns>
